        ...
        if (data != undefined) {
          ...
          data.forEach(sport => {
            if (parseInt(sport.ID) == ID) {
              ...
              <div data-coef="1" class="cell w33">
                <button data-coef="1" class="button coefficient" style="padding-left: 10px;" data-eventNA="${sport.CT[i].EV[0].NA}" data-marketNA="${sport.CT[i].EV[0].MA[0].NA}" data-BS="${sport.CT[i].EV[0].MA[0].PA[1].BS}" data-FI="${sport.CT[i].EV[0].MA[0].PA[1].FI}" data-HA="${sport.CT[i].EV[0].MA[0].PA[1].HA}" data-HD="${sport.CT[i].EV[0].MA[0].PA[1].HD}" data-ID="${sport.CT[i].EV[0].MA[0].PA[1].ID}" data-IT="${sport.CT[i].EV[0].MA[0].PA[1].IT}" data-NA="${sport.CT[i].EV[0].MA[0].PA[1].NA}" data-OD="${sport.CT[i].EV[0].MA[0].PA[1].OD}" data-OR="${sport.CT[i].EV[0].MA[0].PA[1].OR}" data-SU="${sport.CT[i].EV[0].MA[0].PA[1].SU}">
              ...
              <div data-coef="1" class="cell w33">
                <button data-coef="1" class="button coefficient" style="padding-left: 10px;" data-eventNA="${sport.CT[i].EV[0].NA}" data-marketNA="${sport.CT[i].EV[0].MA[0].NA}" data-BS="${sport.CT[i].EV[0].MA[0].PA[2].BS}" data-FI="${sport.CT[i].EV[0].MA[0].PA[2].FI}" data-HA="${sport.CT[i].EV[0].MA[0].PA[2].HA}" data-HD="${sport.CT[i].EV[0].MA[0].PA[2].HD}" data-ID="${sport.CT[i].EV[0].MA[0].PA[2].ID}" data-IT="${sport.CT[i].EV[0].MA[0].PA[2].IT}" data-NA="${sport.CT[i].EV[0].MA[0].PA[2].NA}" data-OD="${sport.CT[i].EV[0].MA[0].PA[2].OD}" data-OR="${sport.CT[i].EV[0].MA[0].PA[2].OR}" data-SU="${sport.CT[i].EV[0].MA[0].PA[2].SU}">
